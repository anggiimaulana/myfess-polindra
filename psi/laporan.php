                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            while ($row = $posts->fetch_assoc()) {
                                ...
                                $display_file = (strlen($file) > 15) ? substr($file, 0, 15) . '...' : $file;
                                ...
                                echo "<tr>
                                        ...
                                        <td>
                                            <button class='button tinjau'><a href='r/report.php?id={$id_report}'>Tinjau</a></button>
                                            <button class='button hapus'><a href='r/report.php?id={$id_report}'>Hapus</a></button>
                                        </td>
                                    </tr>";
                            }
                            ?>
