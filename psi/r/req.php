<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(mysqli_query($conn, $update_query)){
            echo "<script>alert('Status berhasil diperbarui!'); window.location.href='../konsultasi.php';</script>";
        } else {
                    ...
                    <form method="POST">
						...
						<div class="status-group">
							...
							<select name="status" id="status">
								...
								<option value="1" <?php echo ($post_data['status'] == 1) ? 'selected' : ''; ?>>Jadwalkan</option>
								<option value="2" <?php echo ($post_data['status'] == 2) ? 'selected' : ''; ?>>Selesai</option>
							</select>
						</div>
