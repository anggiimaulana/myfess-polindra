...
if (isset($_POST['simpan'])) {
    ...
    if ($error !== '') {
        echo "<script>alert('$error'); window.location.href='../setting/ganti-password.php';</script>";
        exit();
    }
} else {
    echo "<script>alert('Akses tidak sah!'); window.location.href='../setting/ganti-password.php';</script>";
    exit();
}
?>
