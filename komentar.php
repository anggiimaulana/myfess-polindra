...
<body>
    <div class="wrapper">
        <section class="komen-area">
            <header>
                <a href="home.php" class="back-icon">X</a>
                <div class="details">
                    <span>Komentar</span>
                </div>
            </header>
            ...
            <form action="insert_komentar.php" class="typing-area">
    ...
    <script>
        ...
        sendBtn.onclick = () => {
            ...
            xhr.open("POST", "php/insert_komentar.php", true);
            xhr.onload = () => {
        ...
        setInterval(()=> {
            let xhr = new XMLHttpRequest();
            xhr.open("POST", "php/get_komentar.php", true);
            xhr.onload = () => {
                if (xhr.readyState === XMLHttpRequest.DONE) {
                    if(xhr.status === 200) {
